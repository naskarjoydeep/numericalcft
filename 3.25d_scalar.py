#3.25D First Scalar Operator Bound
...
dim_phi= [0.626, 0.628, 0.630, 0.632, 0.634, 0.635, 0.636, 0.638, 0.640, 0.645, 0.65, 0.7, 0.75]
...
#plotting the figure
plt.plot(dim_phi, result, label = "D=3.25")
# naming the x axis
plt.xlabel('d')
# naming the y axis
plt.ylabel('f(d)')
